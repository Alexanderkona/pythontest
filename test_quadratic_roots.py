...
class TestLibraryApp(unittest.TestCase):
    def setUp (self):
        self.library_app = LibraryApp(MagicMock())  # Используем MagicMock вместо tk.Tk()
    ...
    def test_add_book_valid_data (self, mock_showinfo):
        self.library_app.title_entry = MagicMock()  # Заглушка для title_entry
        self.library_app.author_entry = MagicMock()  # Заглушка для author_entry
        self.library_app.title_entry.get.return_value = "1984"
        self.library_app.author_entry.get.return_value = "George Orwell"
    ...
    def test_add_book_empty_title (self, mock_showwarning):
        self.library_app.author_entry = MagicMock()
        self.library_app.author_entry.get.return_value = "George Orwell"
        self.library_app.title_entry = MagicMock()
        self.library_app.title_entry.get.return_value = ""
    ...
    def test_add_book_empty_author (self, mock_showwarning):
        ...
        self.library_app.title_entry.get.return_value = "1984"
        self.library_app.author_entry = MagicMock()
        self.library_app.author_entry.get.return_value = ""
    ...
    def test_add_book_title_too_long (self, mock_showwarning):
        ...
        self.library_app.title_entry = MagicMock()
        self.library_app.title_entry.get.return_value = long_title
        self.library_app.author_entry = MagicMock()
        self.library_app.author_entry.get.return_value = "George Orwell"
    ...
    def test_add_book_author_too_long (self, mock_showwarning):
        ...
        self.library_app.title_entry.get.return_value = "1984"
        self.library_app.author_entry = MagicMock()
        self.library_app.author_entry.get.return_value = long_author
